...
export default function CreateProject() {
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            // Assuming backend returns just filename string or object with filename
            // The FileController returns just the string filename
            const fileName = res.data;
            // Construct full URL or relative path depending on how you serve
            // For now, let's assume serving via /api/public/files/
    ...
    return (
        <div>
            ...
            <h2 className="text-2xl font-bold mb-8 text-gray-900 dark:text-white">Create New Project</h2>
